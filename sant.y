...
Fonction : type mcROUTINE identificateur paraO Liste  DECLARATIONS INSTR identificateur = INTEGER mcENDR
Programme_pr : mcPROGRAM DECLARATIONS INSTR mcEND


Liste : identificateur  Liste1
Liste1 : virgule identificateur Liste1 | paraF | epsilon
...
APPEL_FONC : mcCALL identifcateur paraO Liste point_virgule

MATH_VAR : ID MATH_VAR1
...
ES : mcREAD paraO identificateur paraF point_virgule | WRITE paraO chaine virgule Liste virgule chaine paraF point_virgule
...
Boucle : mcDOWHILE paraO EXPR_CONDI paraF Boucle_INSTR mcENDDO
