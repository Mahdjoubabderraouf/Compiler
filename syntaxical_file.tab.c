...
#line 125 "syntaxical_file.tab.c"
...
{
       0,    88,    88,    99,   104,   108,    87,   119,   118,   135,
     134,   139,   143,   154,   160,   159,   169,   168,   177,   176,
     188,   187,   199,   205,   204,   222,   221,   240,   239,   251,
     250,   266,   265,   273,   272,   283,   285,   287,   289,   294,
     296,   297,   303,   305,   307,   309,   310,   317,   316,   340,
     339,   366,   365,   393,   396,   399,   402,   405,   414,   435,
     413,   450,   449,   479,   478,   517,   516,   552,   551,   569,
     568,   585,   584,   601,   600,   618,   617,   635,   634,   651,
     656,   660,   659,   677,   676,   694,   693,   713,   712,   727,
     742,   759,   773,   787,   793,   798,   806,   808,   810,   815,
     817,   824,   822,   832,   833,   839,   845,   851,   857,   863,
     870,   878,   883,   883,   887,   889,   893,   895,   900,   902,
     904,   909,   911,   913,   915,   917,   919,   921,   923,   928,
     930,   932,   934,   936,   938,   944,   946,   950,   952,   954,
     956
};
#endif
...
#line 1477 "syntaxical_file.tab.c"
    break;
...
#line 1496 "syntaxical_file.tab.c"
    break;

  case 9: /* $@6: %empty  */
#line 135 "syntaxical_file.y"
    { 
        strcpy(sauvType, (yyvsp[-1].string)); 
        strcpy(IDF, (yyvsp[0].string));
    }
#line 1505 "syntaxical_file.tab.c"
    break;

  case 12: /* caractere1: etoile INTEGER  */
#line 144 "syntaxical_file.y"
    {
...
#line 1555 "syntaxical_file.tab.c"
    break;

  case 20: /* $@10: %empty  */
#line 188 "syntaxical_file.y"
    {   
...
#line 1570 "syntaxical_file.tab.c"
    break;

  case 23: /* $@11: %empty  */
#line 205 "syntaxical_file.y"
    { 
        if(addVariable(IDF, sauvType, IDFCode, 1, "NULL", sauvPlace)) {sprintf(errorMsg,"double declaration de %s",IDF) ; yyerror(errorMsg);}
...
#line 1589 "syntaxical_file.tab.c"
    break;

  case 25: /* $@12: %empty  */
#line 222 "syntaxical_file.y"
    { 
        if(addVariable(IDF, sauvType, IDFCode, 1, "NULL", sauvPlace)) {sprintf(errorMsg,"double declaration de %s",IDF) ; yyerror(errorMsg);}
        if (strcmp(IDFCode, "Tableau") == 0) 
        { 
...
#line 1609 "syntaxical_file.tab.c"
    break;
...
#line 1623 "syntaxical_file.tab.c"
    break;

  case 29: /* $@14: %empty  */
#line 251 "syntaxical_file.y"
    {
        if((yyvsp[-3].entier)==0 || (yyvsp[-1].entier)==0)
        {
            sprintf(errorMsg, "la taille doit être suprieur à 0 ");
...
#line 1638 "syntaxical_file.tab.c"
    break;

  case 31: /* $@15: %empty  */
#line 266 "syntaxical_file.y"
    {   
        if(addVariable(IDF, sauvType, IDFCode, 1, "NULL", sauvPlace)){sprintf(errorMsg,"double declaration de %s",IDF) ; yyerror(errorMsg);}
        strcpy(IDFCode, "Var Simple");
    }
#line 1647 "syntaxical_file.tab.c"
    break;
...
#line 1657 "syntaxical_file.tab.c"
    break;
...
#line 1737 "syntaxical_file.tab.c"
    break;

  case 57: /* EXPR: caracter  */
#line 406 "syntaxical_file.y"
    {
        // Semantic code for caracter
    }
#line 1745 "syntaxical_file.tab.c"
    break;
...
#line 1770 "syntaxical_file.tab.c"
    break;

  case 59: /* $@21: %empty  */
#line 435 "syntaxical_file.y"
...
#line 1783 "syntaxical_file.tab.c"
    break;
...
#line 1892 "syntaxical_file.tab.c"
    break;
...
#line 1929 "syntaxical_file.tab.c"
    break;

  case 71: /* $@27: %empty  */
#line 585 "syntaxical_file.y"
...
#line 1947 "syntaxical_file.tab.c"
    break;

  case 73: /* $@28: %empty  */
#line 601 "syntaxical_file.y"
    {
...
#line 1966 "syntaxical_file.tab.c"
    break;

  case 75: /* $@29: %empty  */
#line 618 "syntaxical_file.y"
    {   
...
#line 1985 "syntaxical_file.tab.c"
    break;

  case 77: /* $@30: %empty  */
#line 635 "syntaxical_file.y"
    {   
...
#line 2004 "syntaxical_file.tab.c"
    break;

  case 81: /* $@31: %empty  */
#line 660 "syntaxical_file.y"
    {   
        if ((yyvsp[0].entier) > 0 || (yyvsp[0].entier) < -32768 )
        {
            sprintf(errorMsg, "erreur dans l'intervale ");
...
#line 2096 "syntaxical_file.tab.c"
    break;

  case 90: /* MATH_VAR1: INTEGERPOSITIF  */
#line 743 "syntaxical_file.y"
    {
        if (strcmp(sauvType,"INTEGER") && strcmp(sauvType,"REAL") ) 
        {
             sprintf(errorMsg, "erreur dans l'intervale ");
...
#line 794 "syntaxical_file.y"
    {
        sprintf(string,"%s%s",string,(yyvsp[-1].string));
    }
#line 2159 "syntaxical_file.tab.c"
    break;
...
#line 2167 "syntaxical_file.tab.c"
    break;
...
#line 871 "syntaxical_file.y"
    {   
        Nombre_de_paramètres++;
        addVariable((yyvsp[0].string),"pas de type","Var Simple",1,"NULL",listeSource);
    }
#line 2224 "syntaxical_file.tab.c"
    break;
...
#line 883 "syntaxical_file.y"
                                                                        {condition = 0;}
#line 2236 "syntaxical_file.tab.c"
    break;


#line 2240 "syntaxical_file.tab.c"
